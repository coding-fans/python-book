...
.. meta::
    :description lang=zh:
        ...
        本文从ASCII码说起，带你扒一扒编码背后那些事。
        相信搞清编码的原理后，你将不再畏惧任何编码问题，彻底与乱码说拜拜。
    :keywords: python, unicode, utf8, 编码, 乱码解决, gb2312, gbk, gb18030, ascii, latin1
...
有同事质疑你的数据是乱码，虽然你很确定传了 *UTF-8* ，但无法自证清白，更别说帮同事 *debug* 了。
